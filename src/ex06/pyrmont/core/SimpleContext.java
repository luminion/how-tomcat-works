...
/**
 * 应用程序上下文容器
 * 在ex05.pyrmont.core.SimpleContext的基础上，添加了生命周期接口并实现了相关方法，移除了多余阀
 * 在初始化成员变量时，创建了一个LifecycleSupport类，用于管理生命周期
 * 布尔变量started标识程序是否开始运行
 *
 */
public class SimpleContext implements Context, Pipeline, Lifecycle {
  ...
  public synchronized void start() throws LifecycleException {
    ...
    // 向所有此容器关联的监听器发出BEFORE_START_EVENT的通知
    ...
    // Notify our interested LifecycleListeners
    // 向所有此容器关联的监听器发出AFTER_START_EVENT的通知
  ...
  public void stop() throws LifecycleException {
    ...
    // Notify our interested LifecycleListeners
    // 向所有此容器关联的监听器发出BEFORE_STOP_EVENT的通知
    lifecycle.fireLifecycleEvent(BEFORE_STOP_EVENT, null);
    // 向所有此容器关联的监听器发出STOP_EVENT的通知
    ...
    // Notify our interested LifecycleListeners
    // 向所有此容器关联的监听器发出AFTER_STOP_EVENT的通知
